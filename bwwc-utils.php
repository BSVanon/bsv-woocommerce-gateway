...
require_once(dirname(__FILE__) . '/includes/address-generation.php');
require_once(dirname(__FILE__) . '/includes/blockchain-api.php');
require_once(dirname(__FILE__) . '/includes/exchange-rates.php');
require_once(dirname(__FILE__) . '/includes/gateway-validation.php');
require_once(dirname(__FILE__) . '/includes/string-utilities.php');
