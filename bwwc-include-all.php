...
require_once __DIR__ . '/includes/gateway-migration.php';
// ---------------------------------------------------------------------------
...
require_once __DIR__ . '/libs/util/bcmath_Utils.php';
require_once __DIR__ . '/libs/util/gmp_Utils.php';
require_once __DIR__ . '/libs/CurveFp.php';
require_once __DIR__ . '/libs/Point.php';
require_once __DIR__ . '/libs/NumberTheory.php';
require_once __DIR__ . '/libs/ElectrumHelper.php';

// Load v6 modular architecture
require_once __DIR__ . '/includes/bootstrap.php';

require_once __DIR__ . '/bwwc-cron.php';
require_once __DIR__ . '/bwwc-mpkgen.php';
require_once __DIR__ . '/bwwc-utils.php';
require_once __DIR__ . '/bwwc-admin.php';
require_once __DIR__ . '/bwwc-render-settings.php';
require_once __DIR__ . '/bwwc-bitcoin-gateway.php';
require_once __DIR__ . '/bwwc-dashboard-widget.php';
require_once __DIR__ . '/includes/bsv-payment-console.php';
require_once __DIR__ . '/includes/bsv-payment-check.php';
